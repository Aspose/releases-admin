            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <div style="padding: 15px;">
                        ...
                        <input type="text" style="margin-bottom: 0;" name="new_zip_file_name" id="new_zip_file_name" placeholder="Zip File Name" value="{{ $new_zip_file_name }}"> <button href="?generate=true" class="btn" id="getallnetdll" onclick='getMessage()'> Generate Zip File</button>
